  ...
  return (
    <div className="flex flex-col lg:flex-row items-center justify-center mt-[24px] lg:mt-[56px] px-[32px] lg:px-[0px] min-w-[375px] lg:w-auto gap-[72px] py-[24px] lg:py-[48px] min-h-[724px] lg:min-h-[476px]">
      <div className="min-w-[311px] lg:w-[576px] flex flex-col gap-[64px]">
        ...
        <div className="flex flex-col w-[311px] md:w-[65%] mx-auto lg:flex-row gap-[12px] lg:gap-[24px]">
          <Link href="/" className='rounded-[32px] block max-w-[100%] lg:w-[223px] h-[56px] py-[16px] px-[32px] bg-[#08C056] group'>
            <button className="flex items-center justify-between lg:min-w-[159px] w-[100%] cursor-pointer">
          ...
          <Link href="/" className=' rounded-[32px] max-w-[100%] lg:w-[223px] h-[56px] py-[16px] px-[32px] border-2 border-[#BED0FF] hover:bg-[#BED0FF]/60 group duration-300'><button className={`${publicSans.variable} cursor-pointer max-w-[223px] min-w-[159px] font-bold text-[#2140D4] group-hover:text-[#2140D4]/70`}><span>Schedule a Demo</span></button></Link>
        </div>
      </div>
      <div>
        <Image src="/Images/Illustration.png" alt="Illustration" width="550" height="379" priority={true} className='relative left-[16.29px] w-[550px] h-[379px]' />
      </div>
    </div>
  )
}