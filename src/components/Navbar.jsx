...
export default function Navbar() {
  return (
    <div className="fixed min-w-[375px] z-[99999999] top-0 left-0 lg:pl-6 lg:bg-[var(--navbarbg)] border-b border-[var(--navbarbb)] w-screen" >
      <div className="min-w-[375px] 2xl:w-[1440px] mx-auto flex justify-between items-center px-6 xl:px-[96px] py-[12px] h-[80px]">
        <div className="flex items-center gap-[100px]">
          ...
          <div className="hidden font-[700] text-[var(--linkLightmode)] lg:flex gap-[48px]">
        ...
        <div className="hidden lg:flex gap-[32px] font-bold">
          ...
          <Link href="/">
            <button className="rounded-[32px] h-[56px] w-[154px] bg-[#2140D4] hover:bg-[#2140D4]/80 duration-300">
              <span className="text-[var(--FAQbgLightmode1)]">Get Started</span>
            </button>
          </Link>
        </div>
